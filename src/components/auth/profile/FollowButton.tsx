...
const FollowButton = ({ user, loggedInUser, handleFollow, handleUnfollow }:FollowButtonInterface) => {
//   return (
    ...
    if (isRequested) {
      return <button className='m-1  text-blue-400 bg-gray-100 font-semibold border-2 p-1 px-2 rounded-md'>Requested</button>;
    }
