         ...
         <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 sm:bottom-bar-hidden" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
               <ul className="space-y-5 font-medium">
                  ...
                  <li>
                     <Link to="/admin/users-list" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <LiaUserFriendsSolid className="w-7 h-7 "/>
                        <span className="flex-1 ms-3 whitespace-nowrap">Users List</span>
                     </Link>
                  </li>
                  <li>
                     <Link to="/admin/report-management" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span className="flex-1 ms-3 whitespace-nowrap">Report Management</span>
                     </Link>
                  </li>
                  <li>
